angular.module('myApp').controller('SelectCountryController', ['$http', '$scope', '$location', '$translate', '$q', '$timeout', 'NavigationService', 'EntityUtilService', 'CountryService', function($http, $scope, $location, $translate, $q, $timeout, NavigationService, EntityUtilService, CountryService) {
