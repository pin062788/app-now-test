angular.module('myApp').controller('ListCountryController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'CountryService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, CountryService) {
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(CountryService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(CountryService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			CountryService, "countries", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
